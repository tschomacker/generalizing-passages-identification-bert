...
def write_to_csv(documents, csv_dir: str, test_document_ids, validate_document_ids):
...
def main(input_path, output_path, test_document_ids, validate_document_ids):
    ...
    write_to_csv(documents, os.path.join(output_path), test_document_ids, validate_document_ids)
...
if __name__ == '__main__':
    ...
    main(None, None, args.test, args.validate)